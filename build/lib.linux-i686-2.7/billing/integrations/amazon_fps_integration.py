...
class AmazonFpsIntegration(Integration):
    ...
    def __init__(self, options=None):
        if not options:
            options = {}
        self.aws_access_key = options.get("aws_access_key", None) or settings.GATEWAY_SETTINGS.AWS_ACCESS_KEY
        self.aws_secret_access_key = options.get("aws_secret_access_key", None) or settings.GATEWAY_SETTINGS.AWS_SECRET_ACCESS_KEY
