...
class BraintreePaymentsIntegration(Integration):
    def __init__(self, options=None):
        ...
        test_mode = getattr(settings.GATEWAY_SETTINGS, "MERCHANT_TEST_MODE", True)
        if test_mode:
        ...
        braintree.Configuration.configure(
            env,
            settings.GATEWAY_SETTINGS.BRAINTREE_MERCHANT_ACCOUNT_ID,
            settings.GATEWAY_SETTINGS.BRAINTREE_PUBLIC_KEY,
            settings.GATEWAY_SETTINGS.BRAINTREE_PRIVATE_KEY
            )
